...
export default function HomePage() {
  ...
  const handleSearch = () => {
    navigate(
      `/search?specialty=${encodeURIComponent(
        searchSpecialty,
      )}&location=${encodeURIComponent(searchLocation)}&name=${encodeURIComponent(searchName)}`,
    );
  };
  ...
  return (
    <div className="font-sans text-gray-900 bg-white overflow-x-hidden">
      ...
      <section
        ...
        style={{
          backgroundImage: "url('../assets/doctor-bg.png')",
          ...
          <div className="w-full flex justify-center lg:justify-start">
            <div className="w-full max-w-2xl lg:max-w-[720px] py-16 md:py-24 lg:py-28 text-left">
              ...
              <div className="flex items-center gap-3 mb-6 md:mb-8">
                <div className="bg-[#00342b] text-white rounded-lg h-12 w-12 flex items-center justify-center text-2xl font-bold shrink-0 shadow-lg">
                  N
                </div>
                <div className="leading-tight">
                  <p className="text-[10px] md:text-xs tracking-[0.28em] font-semibold text-gray-700">
                    NETWORK OF
                  </p>
                  <p className="text-lg md:text-xl font-bold text-gray-900 uppercase">
                    Muslim Physicians
                  </p>
                </div>
              </div>
              ...
              <p className="text-base md:text-xl text-gray-600 max-w-xl mb-8 md:mb-10">
                Easily discover Muslim doctors who understand your culture and
                values.
              </p>
        ...
        <div className="max-w-[1500px] mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500">
              Find your trusted Muslim physician in 3 simple steps
            </p>
          </div>
            ...
            {steps.map((step) => (
              ...
              >
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(135deg, rgba(236,253,245,0.8) 0%, rgba(209,250,229,0.5) 100%)",
                  }}
                >
                  <span
                    className={`absolute top-4 left-4 ${step.numBg} text-white w-10 h-10 flex items-center justify-center rounded-lg font-bold text-xl`}
                  >
                    {step.num}
                  </span>
                  {step.icon}
