      ...
      <div className="space-y-6">
        ...
        {loading ? (
          <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
            {[1, 2, 3, 4].map((i) => (
              <div
                key={i}
                className="bg-white rounded-2xl border border-[#e1e3e4] p-5 animate-pulse"
              >
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <div className="bg-white rounded-2xl border border-[#e1e3e4] p-6">
            <h3 className="text-lg font-bold text-[#00342b] mb-2">
              Quick Actions
            </h3>
          ...
          <div className="bg-white rounded-2xl border border-[#e1e3e4] p-6">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between text-sm">
                ...
                <span
                  className={`flex items-center gap-1.5 font-medium ${error ? "text-red-600" : "text-green-600"}`}
                >
                  <span
            ...
            <p className="text-xs text-[#707975] mt-3">
              ...
              <code className="font-mono">
                {process.env.REACT_APP_API_URL || "https://nompus.com/api"}
              </code>
            </p>
          </div>
        </div>
